...
// Icon-only link items render inline next to the theme toggle in the
// docs sidebar footer (and as compact icons in the home navbar).
const socialLinks: LinkItemType[] = [
  ...
  },
  {
    ...
    text: 'LinkedIn',
    label: 'LinkedIn',
    url: 'https://www.linkedin.com/company/masstdev',
    icon: LinkedInIcon,
    external: true,
  },
];
