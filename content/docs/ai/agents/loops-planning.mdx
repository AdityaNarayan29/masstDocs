...
description: The agent loop in production — ReAct, Tree of Thoughts, Reflexion, plan-then-execute. Stopping conditions, context-bomb prevention, orchestrator-workers, and a full ReAct loop in Python.
---
