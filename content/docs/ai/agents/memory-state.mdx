...
description: Working, episodic, and semantic memory for LLM agents. Conversation summarization, fact extraction, vector store memory (Mem0, MemGPT/Letta), user profiles, checkpointing, and the privacy implications of remembering users across sessions.
---
