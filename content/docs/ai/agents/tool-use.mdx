...
Already covered above, but it bears repeating because it's the single most common mistake. If your toolset has grown organically past 20 tools, build a **tool router**: an initial small LLM call that picks a subset of relevant tools, and pass only those to the main agent.
