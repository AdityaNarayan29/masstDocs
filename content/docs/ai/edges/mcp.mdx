...
description: MCP — architecture, stdio vs HTTP transports, resources/tools/prompts/sampling primitives, the Claude Code / Cursor / Cline ecosystem, security, and a working TypeScript server.
---
