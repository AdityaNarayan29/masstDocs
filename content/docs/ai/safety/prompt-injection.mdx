...
- **Per-request budget envelopes** ("you have $5 to spend on this task" — when the budget runs out, the tool layer refuses further calls).
...
After the model emits an action plan or a final answer, run independent checks:
