---
title: WhatsApp
description: How WhatsApp delivers 100B+ messages daily to 2B+ users — Erlang stack, end-to-end encryption, presence, and offline delivery.
---
...
graph TD
    ...
    subgraph "Delivery States"
        SENT[Sent<br/>Single Check ✓]
        DELIVERED[Delivered<br/>Double Check ✓✓]
        READ[Read<br/>Blue Checks ✓✓]
