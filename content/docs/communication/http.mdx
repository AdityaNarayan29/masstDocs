---
title: HTTP
description: HTTP — methods, status codes, headers, HTTP/1.1 vs HTTP/2 vs HTTP/3, keepalive, and what every system designer should know.
---
