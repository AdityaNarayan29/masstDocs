...
| **Pattern** | **Where** |
|------------|-----------|
| **[State](/lld/patterns/behavioral/state)** | `FlightStatus`, `SeatStatus`, `BookingStatus` |
| **[Strategy](/lld/patterns/behavioral/strategy)** | Fare rules (refund policy), search algorithm |
| **[Facade](/lld/patterns/structural/facade)** | `AirlineService` |
| **Repository** | Flights, bookings, passengers |
| **[Observer](/lld/patterns/behavioral/observer)** | Notify passenger of delays / changes |
| **[Builder](/lld/patterns/creational/builder)** | Itinerary construction |
| **[Composite](/lld/patterns/structural/composite)** | `Itinerary` is a list of `Flight` segments — uniform treatment |
