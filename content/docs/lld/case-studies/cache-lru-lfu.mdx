...
| **Pattern** | **Where** |
|------------|-----------|
| **[Strategy](/lld/patterns/behavioral/strategy)** | `EvictionPolicy` swappable |
| **[Decorator](/lld/patterns/structural/decorator)** | `TTLCache` wraps any `Cache` |
| **[Singleton](/lld/patterns/creational/singleton)** | One cache instance per app context |
| **[Observer](/lld/patterns/behavioral/observer)** | Listeners on eviction (write-behind cache) |
