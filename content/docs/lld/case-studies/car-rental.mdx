...
| **Pattern** | **Where** |
|------------|-----------|
| **State** | Vehicle status (Available / Reserved / Rented / Maintenance) |
| **Strategy** | Pricing (standard, hourly, weekly, surge) |
| **Facade** | `RentalService` |
| **Observer** | Notify customer at confirmation / pickup reminder / late |
| **Repository** | Reservations, vehicles, customers |
| **Builder** | `Bill` with many components (base, mileage, late, fuel, damage) |
