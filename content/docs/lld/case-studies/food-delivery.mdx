...
> The HLD case study is at [/hld](/hld). This page focuses on **classes and state**, not infrastructure.
...
| **Pattern** | **Where** |
|------------|-----------|
| **[State](/lld/patterns/behavioral/state)** | `OrderStatus` lifecycle |
| **[Strategy](/lld/patterns/behavioral/strategy)** | Pricing rules, partner assignment, discount rules |
| **[Facade](/lld/patterns/structural/facade)** | `OrderService` orchestrates |
| **[Observer](/lld/patterns/behavioral/observer)** | Notifications to user/restaurant/partner |
| **[Builder](/lld/patterns/creational/builder)** | Cart → Order conversion |
