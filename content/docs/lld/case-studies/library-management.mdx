...
| **Pattern** | **Where** |
|------------|-----------|
| **[Facade](/lld/patterns/structural/facade)** | `LibraryService` simplifies multi-step flows |
| **[State](/lld/patterns/behavioral/state)** | `CopyStatus`, `MemberStatus` |
| **[Strategy](/lld/patterns/behavioral/strategy)** | Late-fee calculation (per-day, escalating, capped) |
| **[Observer](/lld/patterns/behavioral/observer)** | Notify members when holds become available |
| **Repository** | `Catalog`, `LoanRepository` for persistence abstraction |
| **[Singleton](/lld/patterns/creational/singleton)** | `LibraryService` (per app instance) |
