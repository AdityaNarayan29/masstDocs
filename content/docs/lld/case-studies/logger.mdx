...
| **Factory** | Logger creation by name |
| **Strategy** | `Formatter` |
| **Decorator** | `AsyncAppender` wraps any appender |
| **Chain of responsibility** | Hierarchical logger lookup |
| **Observer** | Appenders subscribe to logger output |
| **Producer-consumer** | AsyncAppender's queue + worker |
