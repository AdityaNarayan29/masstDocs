...
| **Pattern** | **Where** |
|------------|-----------|
| **Facade** | `Calendar` service |
| **Strategy** | `RecurrenceRule` (daily, weekly, monthly, custom) |
| **Observer** | Notify attendees on book / change / cancel |
| **State** | `MeetingStatus` lifecycle |
| **Composite** | Recurring meeting → expanded child meetings |
| **Singleton** | One Calendar per workspace |
