...
| **Pattern** | **Usage** |
|------------|-----------|
| **[Singleton](/lld/patterns/creational/singleton)** | ParkingLot instance |
| **[Factory](/lld/patterns/creational/factory)** | Vehicle creation |
| **[Strategy](/lld/patterns/behavioral/strategy)** | Pricing calculation |
| **[Observer](/lld/patterns/behavioral/observer)** | Display board updates |
| **[State](/lld/patterns/behavioral/state)** | Ticket status management |
