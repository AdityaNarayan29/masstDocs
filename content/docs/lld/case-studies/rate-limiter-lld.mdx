...
> The HLD case study is at [/sd/case-studies/rate-limiter](/sd/case-studies/rate-limiter). This page focuses on the **algorithm** and class design.
...
| **Pattern** | **Where** |
|------------|-----------|
| **Strategy** | Different rate-limiting algorithms behind one interface |
| **Singleton** | One limiter per application instance |
| **Decorator** | Wrap a limiter with logging, metrics, multi-tier |
| **Factory** | Construct limiter from config |
