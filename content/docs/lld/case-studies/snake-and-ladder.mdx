...
| **Pattern** | **Where** |
|------------|-----------|
| Strategy | Dice (standard, weighted, multi-dice) |
| Builder | Board configuration with snakes/ladders lists |
| Observer | Game broadcasts moves to UI listeners |
| Template method | `Game.play()` skeleton, subclass overrides for variants |
