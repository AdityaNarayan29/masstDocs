...
| **Pattern** | **Where** |
|------------|-----------|
| **[Strategy](/lld/patterns/behavioral/strategy)** | `SplitStrategy` (Equal / Exact / Percent) |
| **[Facade](/lld/patterns/structural/facade)** | `SplitwiseService` |
| **[Observer](/lld/patterns/behavioral/observer)** | Notify users when added to expense |
| **[Memento](/lld/patterns/behavioral/memento)** | Reverse expense for edits/undo |
| **Repository** | `BalanceRepository`, `ExpenseRepository` |
| **[Builder](/lld/patterns/creational/builder)** | Build complex `Expense` (many participants) |
