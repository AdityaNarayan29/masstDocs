...
| **Pattern** | **Where** |
|------------|-----------|
| **[Strategy](/lld/patterns/behavioral/strategy)** | Reputation rules (per event type) |
| **[Facade](/lld/patterns/structural/facade)** | `QnaService` |
| **[Observer](/lld/patterns/behavioral/observer)** | Notify question owner of new answers/comments |
| **[Composite](/lld/patterns/structural/composite)** | Posts contain comments (small composite) |
| **[State](/lld/patterns/behavioral/state)** | Answer accepted / not |
