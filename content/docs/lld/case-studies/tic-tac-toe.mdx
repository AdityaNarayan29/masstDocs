...
| **Pattern** | **Where** |
|------------|-----------|
| **[Strategy](/lld/patterns/behavioral/strategy)** | Win condition (could swap for Connect-Four etc.) |
| **[State](/lld/patterns/behavioral/state)** | `GameStatus` enum |
| **[Observer](/lld/patterns/behavioral/observer)** | UI can subscribe to game events (move played, game over) |
| **[Memento](/lld/patterns/behavioral/memento)** | Snapshot board for undo |
| **[Command](/lld/patterns/behavioral/command)** | Each move as a reversible command |
