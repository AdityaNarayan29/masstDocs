...
| **Pattern** | **Where** |
|------------|-----------|
| **[State](/lld/patterns/behavioral/state)** | `SignalState` machine |
| **[Strategy](/lld/patterns/behavioral/strategy)** | Phase timings (default / rush-hour / off-peak) |
| **[Observer](/lld/patterns/behavioral/observer)** | Lights subscribe to state changes |
| **[Command](/lld/patterns/behavioral/command)** | Emergency override as command |
| **[Mediator](/lld/patterns/behavioral/mediator)** | Coordinator orchestrates multiple intersections |
| **[Singleton](/lld/patterns/creational/singleton)** | One controller per intersection |
