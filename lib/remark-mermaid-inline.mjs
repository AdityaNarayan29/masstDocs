...
/**
 * Create an MDX JSX element for the mermaid diagram
 * This properly integrates with MDX's AST instead of raw HTML
 */
function createMermaidJsxElement(lightSvg, darkSvg) {
  // Create the JSX structure that MDX can process
  return {
    ...
    attributes: [
      {
        ...
        name: 'className',
        value: 'mermaid-container my-6 overflow-x-auto',
      },
      {
        type: 'mdxJsxAttribute',
    ...
    visit(tree, 'code', (node, index, parent) => {
      if (node.lang === 'mermaid' && parent && index !== null) {
        ...
        if (cached) {
          ...
          if (lightSvg && darkSvg) {
            parent.children[index] = createMermaidJsxElement(lightSvg, darkSvg);
            return;
          }
        }
